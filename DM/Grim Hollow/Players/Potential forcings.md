...
| Subclass                     | Species     | Curse      | Faction                |
| ---------------------------- | ----------- | ---------- | ---------------------- |
| Vermin Lord                  | Dhampir     | Vampire    |                        |
| Bulwark Warrior              | Wechselkind |            | Company of Free Swords |
| Apocalypse Sorcery           |             | Primordial | Prismatic Circle       |
| Leaden Crown/Living Crucible |             |            | Ebon Syndicate         |
...
- Fractured (Jekyll & Hyde)
- Primal Spirit (Spectral beast)
- Wrathful Dead (Bearer of bad deaths)
- Adventurers (Jack of all trades)
- Fools (Viscous mockery)
- Requiems (Stir up spirits)
- Spirits (Medium)
- Eldritch (One bad day)
- Inquisition (Burn the witch!)
- Purification (Burn everyone!)
- Grave (Hasten or slow death)
- Blood (Blood for the blood god)
- Entropy (The power of the sun in the palm of my hand)
- Mutation (Cryptid furry)
- Bulwark Warrior (Tis but a scratch)
- Living Crucible (The Witcher)
- Nightwatcher (Detective)
- Leaden Crown (Psionics)
- Pride (Possibly the worst subclass I've seen)
- Regret (Let others be crushed by your guilt)
- Carver (Psycho slasher)
...
- Vermin Lord (Conor)
- Hollow Warden (Scooby Doo)
- Highway Rider (The Good, the Bad and the Ugly)
- Misfortune Bringer (Jynx)
- Sanguine Thief (Blood money)
- Phantom (Carry the dead with you)
- Apocalypse (Preach the coming end)
- Haunted (Ghost Familiar)
- Wretched Bloodline (Misery loves company)
- Shadow (Hello darkness my old friend)
- Coven (Befuddle)
- First Vampire (Dracula in-training)
- Parasite (Symbiote)
- Undead (Zombie)
- Daemonologist (Faith Larping)
- Plague Doctor (Drinkable spells)
- Sangromancer (Blood bender)
...
- Grudgels (orc but educated)
- Laneshi (amphibious, psychic, dead sibling)
- Ogresh (mind games)
- Accursed (were-whatever)
- Arisen (Zombie)
- Dhampir (Vampire)
- Disembodied (Ethereal body)
- Downcast (mortal celestials)
- Wechselkind (Pinocchio)
- Wulven (Werewolf)

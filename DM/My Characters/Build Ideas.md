...
| --------- | ----------------------------- | ---------------- | ---------------- |
| Barbarian | Berserker/Giant               | Beast            | Wildheart        |
| Bard      | ~~Lore~~                      | Spirits          | NA               |
| Cleric    | Death                         | Twilight         | Trickery         |
| Druid     | Star/Spores                   | Wildfire         | Moon/Land        |
| Fighter   | Arcane Archer/Eldritch Knight | Rune Knight      | Battlemaster     |
| Monk      | Shadow/Open Hand              | Long Death       | NA               |
| Paladin   | Ancients                      | Glory            | Vengence         |
| Ranger    | Beast Master/Gloom Stalker    | Horizon Walker   | Hunter           |
| Rogue     | Swashbuckler                  | Phantom          | Arcane Trickster |
| Sorcerer  | Wild Magic/Shadow Magic       | Aberrant Mind    | NA               |
| Warlock   | GOO/Hexblade                  | Fathomless       | Fiend            |
| Wizard    | Bladsinging/Divination        | Order of Scribes | Evocation        |

## 5.5 and 5E Favorites

| Class     | PHB24         | XGE/TCE        |
| --------- | ------------- | -------------- |
| Barbarian | World Tree    | Beast          |
| Bard      | Glamour       | Eloquence      |
| Cleric    | Light         | Forge          |
| Druid     | Moon          | Wildfire       |
| Fighter   | Psi Warrior   | Rune Knight    |
| Monk      | Elemental     | Drunken Master |
| Paladin   | Devotion      | Conquest       |
| Ranger    | Fey Wanderer  | Swarmkeeper    |
| Rogue     | Soul Knife    | Swashbuckler   |
| Sorcerer  | Aberrant Mind | Divine Soul    |
| Warlock   | Archfey       | Fathomless     |
| Wizard    | Illusionist   | Scribes        |
## Thematic flavors
### Eldritch Hybrid
...
| Paladin   | N/A           |                    |                |
| Ranger    | Hollow Warden | Swarmkeeper        | Vermin Lord    |
...
| Class     | #1        | #2           | #3    |
| --------- | --------- | ------------ | ----- |
| Barbarian | N/A       | Storm Herald |       |
| Bard      | N/A       |              |       |
| Cleric    | Light     | Purification | Forge |
| Druid     | Wildfire  |              |       |
| Fighter   | N/A       |              |       |
| Monk      | Sun Soul  |              |       |
...
| Ranger    | N/A       |              |       |
| Rogue     | N/A       |              |       |
| Sorcerer  | Spellfire | Divine Soul  |       |
| Warlock   | Celestial |              |       |
| Wizard    | N/A       | Evocation    |       |
### Performative Flare
...
| Cleric    | Twilight           | Light              | Inquisition      |
| Druid     | Wildfire           | Stars              | Entropy          |
| Fighter   | Gladiator          | Samurai            | Battlemaster     |
...
### Memento Mori
- Embrace death as penance or joy

| Class     | #1            | #2                 | #3      |
| --------- | ------------- | ------------------ | ------- |
| Barbarian | Wrathful Dead | Ancestral Guardian |         |
| Bard      | Requiem       | Fools              | Spirits |
| Cleric    | Grave         | Twilight           |         |
| Druid     | Entropy       | Spores             |         |
| Fighter   |               |                    |         |
| Monk      |               |                    |         |
| Paladin   | Pestilence    |                    |         |
| Ranger    |               |                    |         |
| Rogue     | Phantom       | Misfortune Bringer |         |
| Sorcerer  | Haunted       | Apocalypse         |         |
| Warlock   | First Vampire | Undead             |         |
| Wizard    |               |                    |         |
